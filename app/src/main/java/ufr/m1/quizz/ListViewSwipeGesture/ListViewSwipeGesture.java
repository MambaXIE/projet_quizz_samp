package ufr.m1.quizz.ListViewSwipeGesture;
...
public class ListViewSwipeGesture implements View.OnTouchListener {
    ...
    private void GetResourcesValues() {
        ...
        HalfDrawable        =   activity.getResources().getDrawable( R.drawable.ic_trash );
        FullDrawable        =   activity.getResources().getDrawable(R.drawable.ic_edit);
    }
    ...
    private void SetBackGroundforList() {
        ...
        RelativeLayout.LayoutParams lp1 =new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.MATCH_PARENT);
